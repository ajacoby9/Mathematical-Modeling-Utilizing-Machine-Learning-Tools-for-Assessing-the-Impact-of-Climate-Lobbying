...
%L = 600;
alpha_C = 0.4035874439;
alpha_F =0.2937219731;
alpha_A = 0.302690583;
Beta_F = 0.00005425;
Beta_A = 0.00005425;
%M_LA = 308800000;
...
h5 = plot(70, 219, 'ko', 'MarkerSize', 8, 'MarkerFaceColor', [0 0.5 0]);  % Point at (70, 219) with green face
h6 = plot(70, 212, 'ko', 'MarkerSize', 8, 'MarkerFaceColor', 'k');  % Point at (70, 212) with maroon face [0.6350 0.0780 0.1840]
h7 = plot(70, 4, 'ko', 'MarkerSize', 8, 'MarkerFaceColor', [0.6350 0.0780 0.1840]);  % Point at (70, 212) with maroon face 
% Set axis labels and title
title({'Predicted Votes for the ACESA in the House',' Without Lobbying'});
xlabel('Time');
...
% Legend
legend([h1, h2, h3, h4, h5, h6, h7], {'S(t)', 'C(t)', 'Y(t)', 'N(t)', 'Actual Yes Vote', 'Actual No Votes', 'Not Voting'}, 'Location', 'bestoutside', 'FontSize', 12);
